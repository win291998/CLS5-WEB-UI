...
const props = withDefaults(defineProps<Props>(), {
  isShowModalUpdateThematic: false,
  excludeIds: [],
})
...
interface Props {
  isShowModalUpdateThematic: boolean
  excludeIds?: any
  courseId?: number
  cost?: any
}
interface Emit {
  (e: 'update:isShowModalUpdateThematic', value: any): void
  (e: 'saveChange'): void
}
...
async function onCancel() {
  emit('update:isShowModalUpdateThematic', false)
}
...
watch(() => props.isShowModalUpdateThematic, isShow => {
  if (isShow) {
...
<template>
  <div>
    <CmDialogs
      :title="LABEL.TITLE"
      :is-dialog-visible="isShowModalUpdateThematic"
