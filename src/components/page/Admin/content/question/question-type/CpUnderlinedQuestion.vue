...
import CpAnserUnderLined from '@/components/page/Admin/content/question/modification/answerType/CpAnserUnderLined.vue'
...
function updatePositionAns() {
  ...
  const elementAns = editableDiv.querySelectorAll('.answer-underline')
  elementAns.forEach((el: any, pos: number) => {
    el.setAttribute('answer-position', pos)
    addAnswer(el.innerHTML)
  })
}
